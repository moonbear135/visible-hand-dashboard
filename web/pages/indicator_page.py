...
# 오너 요청(2026-08-25, 이어서) — "줄 띄우기를 좀 확실하게 해줘, 문장이 너무 길다":
# AI 문장이 길어서 한 줄로 붙어 있으면 눈에 잘 안 들어온다는 지적. 그 문장 앞뒤로
# **빈 줄**(\n\n → <br><br>, error_banner 의 \n→<br> 치환을 그대로 재사용, §0-3-10)을
# 넣어 다른 문장들과 시각적으로 확실히 분리했습니다.
STRONG_WARNING_TEXT = (
    '🙏 여기서부터는 신앙입니다\n'
