...
0. **🔴 대체재는 "되느냐"가 아니라 "써도 되느냐 · 공짜냐"부터 본다** (2026-09-08 오너 지시:
   *"물론 법적인것이랑 비용이 안드는 방향도 무시하면 안되는거야"*).
   ...
   | 관문 | 무엇을 보나 | 못 넘으면 |
   |---|---|---|
   | ⚖️ **법적** | 이용약관 · `robots.txt` · 데이터 재배포·상업적 이용 조건 · 라이선스 | 🔴 **조건이 하나라도 달려 있으면 그 시점에 아웃**(§0-3-17). 오너에게 "그래도 쓸까요?"라고 **묻지 않습니다** — 묻는 것 자체가 검토입니다. 조용히 빼고 다른 대안을 찾습니다 |
   ...
   🔴 **아웃 사유가 되는 조건**(§0-3-17, 예시이며 전부가 아님): 비상업적·비영리 목적 한정 /
   광고 붙은 화면 사용 금지 / 수익화 금지 / 재배포·제3자 제공 금지 / 결과에 대한 대가 청구 금지 /
   사용 전 별도 계약·사전 승인 필요 / 유료 라이선스로만 상업적 이용 가능.
   **법적에서 걸리면 비용·공식성은 보지 않습니다.**
