...
def render_pegy_page():
    ...
    st.markdown('<div class="main-title">💡 사실 이 가격이에요</div>', unsafe_allow_html=True)
    st.markdown('<div class="sub-title">Forward PEGY / PER / EPS 스냅샷 기반 퀀트 적정가치 분석</div>', unsafe_allow_html=True)
