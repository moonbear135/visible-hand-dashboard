...
#: ✅ USD 주문 접수 시간대(5-11-6) — **D일 KST 16:00:00~21:00:00, 양끝 정각·양끝 포함**
#: (2026-08-20 오너 확정: "00시 정각이 더 나을 듯" — KRW 트랙의 "정각에서 1초 뒤에
#: 여는" 관례(`ORDER_WINDOW_OPEN_TIME` 18:00:01)를 USD 에는 따르지 않기로 했습니다.
#: `sql/duel_schema.sql` 의 `duel_orders_usd` 테이블 코멘트("16:00~21:00")와도 맞습니다.
#: ⚠️ KRW 와 USD 가 **다른 관례**(정각+1초 vs 정각)를 쓰는 것이 실수가 아니라 오너가
#: 트랙별로 따로 확정한 값입니다 — 나중에 "왜 두 트랙 상수가 다른 모양이지" 하고
#: 한쪽을 다른 쪽에 맞춰 고치지 마세요.
ORDER_WINDOW_OPEN_TIME_USD = time(16, 0, 0)
